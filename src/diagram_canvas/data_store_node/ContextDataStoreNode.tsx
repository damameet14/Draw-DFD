...
import styles from './ContextDataStoreNode.module.css';
import { useState, useEffect, useRef } from 'react';
import { useDiagramVisibilityPreferences } from '../../application_shell/public_interface';

export const ContextDataStoreNode = ({ data, selected }: NodeProps<DataStoreNodeType>) => {
    ...
    const getPositionFromMouse = (clientX: number, clientY: number): { edge: 'top' | 'bottom', offset: number } => {
        if (!nodeElementReference.current) return { edge: 'bottom', offset: 50 };
